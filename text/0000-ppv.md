...
The number of lanes is only known at run-time. That is, scalable vectors are types
...
practice and designing a portable API for scalable vectors is an open research
problem. 
...
Providing a portable API for both packed and scalable vectors is thus
