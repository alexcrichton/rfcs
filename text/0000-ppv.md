...
with SSSE3 extensions to accelerate multiple substring search and also the
parent crate `teddy`.
...
# Example: scalar multipy even

Lets implement a function that multiplies the even elements of a vector with a
scalar:
